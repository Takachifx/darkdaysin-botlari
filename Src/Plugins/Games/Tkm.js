...
await Dolars.updateOne({guildID: options.message.guild.id, userID: options.opponent.id}, {$inc: {dolar: -options.bahis}, }, {upsert: true})
await Dolars.updateOne({guildID: options.message.guild.id, userID: options.message.author.id}, {$inc: {dolar: -options.bahis}, }, {upsert: true})
Collector.stop();
...
await Dolars.updateOne({guildID: options.message.guild.id, userID: options.opponent.id}, {$inc: {dolar: options.ödül}, }, {upsert: true})
...
await Dolars.updateOne({guildID: options.message.guild.id, userID: options.message.author.id}, {$inc: {dolar: options.ödül}, }, {upsert: true})
;
}
...
.setColor(options.embed.color);
await Dolars.updateOne({guildID: options.message.guild.id, userID: options.opponent.id}, {dolar: options.bahis}, {upsert: true})
await Dolars.updateOne({guildID: options.message.guild.id, userID: options.message.author.id}, {dolar: options.bahis}, {upsert: true})
data.delete(options.opponent.id);
data.delete(options.message.author.id);
return question.edit({
embeds: [_embed],
